...
func TestOpenAPIEndpointDocumentsRoutes(t *testing.T) {
	...
	for _, path := range []string{"/", "/api/admin/incidents/recent", "/v1/admin/dispatch/transcript", "/v1/admin/dispatch/transcripts/recent", "/v1/admin/dispatch/health", "/v1/incidents/active", "/v1/fire-stations", "/v1/stats", "/v1/codes", "/v1/openapi.json", "/v1/health"} {
